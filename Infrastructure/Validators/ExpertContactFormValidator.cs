...
public class ExpertContactFormValidator : AbstractValidator<ExpertRequestFormMain>
{
    public ExpertContactFormValidator()
    {
        RuleFor(x => x.IsConfirmSharingData)
            .Equal(true).WithMessage("Bilgilerin paylaşılmasını onaylamanız gerekmektedir.");
